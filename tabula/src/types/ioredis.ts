...
declare namespace IORedis {
    interface ArgumentTransformerFn {
        (args: Array<any>): Array<any>;
    }

    interface ReplyTransformerFn {
        (result: any): any;
    }

    interface Command {
        setArgumentTransformer(name: string, fn: ArgumentTransformerFn): void;
        setReplyTransformer(name: string, fn: ReplyTransformerFn): void;
    }
    interface Commander {
        new(): Commander;
