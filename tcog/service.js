...
service.get('/p13n/v2/users/:user_id/recommendations', transformers.vidora.v2.generateRecommendations());
service.get('/p13n/v2/users/:user_id/items/:item_id/similars', transformers.vidora.v2.generateSimilarities());
service.get('/p13n/v3/users/:user_id/recommendations', transformers.vidora.v3.generateRecommendations());
...
service.get('/spp-api/v1/widgets/public/:widget_id', transformers.wordpressApi.widgetsAsPublicHtml);
service.get('/spp-api/v1/widgets/:widget_id', transformers.wordpressApi.widgets);
...
service.get('/news/v3/collections/:id', transformers.capi.v3.byId('collections'));
service.get('/news/v3/collections', transformers.capi.v3.bySearch('collections'));
...
service.get('/news/v3/search', transformers.capi.v3.bySearch('search'));
service.get('/news/v3/search/id/:id', transformers.capi.v3.byId('search', '/v3/search/id/:id'));
...
service.get('/news/v3/routes/:id/children/sections', transformers.capi.v3.byId('routes', '/v3/routes/:id/children/sections'));
service.get('/news/v3/routes/domains/:id', transformers.capi.v3.byId('routes', '/v3/routes/domains/:id'));

service.get('/news/v3/sections/:id', transformers.capi.v3.byId('sections'));
service.get('/news/v3/sections/:id/children', transformers.capi.v3.byId('sections', '/v3/sections/:id/children'));
service.get('/news/v3/sections/domains/:id', transformers.capi.v3.byId('domains', '/v3/sections/domains/:id'));

service.get('/news/v3/sections/syndications/domains/:id', transformers.capi.v3.byId('sections', '/v3/sections/syndications/domains/:id'));
service.get('/news/v3/sections/syndications/:id', transformers.capi.v3.byId('sections', '/v3/sections/syndications/:id'));
...
service.use(middleware.statusCodeResponder(404, {
    path: '/404.html',
    root: './public'
}));

service.use(middleware.statusCodeResponder(500, {
    path: '/500.html',
    root: './public'
}));
