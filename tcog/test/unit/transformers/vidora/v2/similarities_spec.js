...
describe('Handle non arrays gracefully', () => {
    describe('vidora integration', () => {
        ...
        it('check if recommendations is array', (done) => {
            ...
            const vidoraIntegration = generateSimilarities(agent)[2];
        ...
        it('passes on non arrays to the end user for feedback', (done) => {
            ...
            vidoraIntegration(req, res, (err) => {
                expect(err).to.be.ok;
                expect(err.message).to.equal('Vidora replied without an array of similarities');
    ...
    describe('capi integration', () => {
        const vidoraRecommendations = {
            items: [
                '4f1cb432c42ee68b741df246dff74283',
                'fe38f8bc6dc147bd5b02c3968e4bef68',
                'e2f7dd83cdc417b1cc6586ddcee60942',
                'ac240ec8aeb909eaa126a18d94b3b7dd',
                'a7f9e074e4d12e670e9904148050a0b5',
                'a6dc5f71b3e95ac796cc029e855c99f5',
                'e46dafd18c2ceef24e4317b8b6add50b',
                '0e0d0d94058706b005b086301c00cd99',
                '781b1fd19f35616acab53d38e9b90c5b',
                '3930a3ea729dcc123d50359fd9365aa7'
            ]
        };
        ...
        it('checks whether res.locals.data is populated with the P13N list', (done) => {
            ...
            const capiIntegration = generateSimilarities(agent)[3];

            capiIntegration(req, res, () => {
                expect(res.locals.data.type).to.deep.equal('P13N_SIMILARITIES_LIST');
